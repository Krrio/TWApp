...
const Explore = () => {
  ...
  return (
    <section className={`${styles.paddings}`} id="explore">
      ...
      >
        <TypingText title="Przeżyj wydarzenia jedyne w swoim rodzaju" textStyles="text-center text-black-50"/>
        <TitleText
          title={<>Zobacz gdzie <br className="md:block hidden" />
          dzieje się magia</>}
